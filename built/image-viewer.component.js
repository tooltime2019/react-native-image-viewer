...
var ImageViewer = /** @class */ (function (_super) {
    ...
    function ImageViewer() {
        ...
        _this.getImageStatus = function () {
            if (_this.state.imageSizes && _this.state.imageSizes[_this.state.currentShowIndex || 0]) {
                return _this.state.imageSizes[_this.state.currentShowIndex || 0].status || 'loading';
            }
            return 'loading';
        };
        /**
    ...
    ImageViewer.prototype.getContent = function () {
        ...
        var imageStatus = this.getImageStatus();
